...
function Button({ children, disabled, to, type, onClick }) {
    const base = `text-stone-800 text-sm inline-block rounded-full bg-yellow-400 
    ...
    const styles = {
        ...
        secondary: `inline-block text-sm rounded-full border-2 text-stone-400   
            ...
            focus:text-stone-800 focus:outline-none
